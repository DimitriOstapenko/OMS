...
# Order currency
  ...
  def self.to_csv
    attributes = %w{id client_name client_code cre_date product_count items_count currency total po_number inv_number pmt_method_str shipping discount tax delivery_by weight status_str notes}
